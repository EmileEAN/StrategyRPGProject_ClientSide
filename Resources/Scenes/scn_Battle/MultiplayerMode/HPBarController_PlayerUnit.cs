...
{
    public class HPBarController_PlayerUnit : MonoBehaviour
    {
        #region Private Fields
        private UnityBattleSystem_Multiplayer m_mainScript;

        private PlayerUnitController m_unitController;
        ...
        void Awake()
        {
            ...
            m_unitController = this.transform.parent.GetComponent<PlayerUnitController>();
