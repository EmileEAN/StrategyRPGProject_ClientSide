...
namespace EEANWorks.Games.TBSG._01.Unity.SceneSpecific
{
    ...
    public class TileMapManager_Multiplayer : MonoBehaviour
    {
        ...
        private bool RotateTiles()
        {
            try
            {
                ...
                {
                    meshRenderer.transform.Rotate(0f, 0f, 180f);
                }
            ...
            {
                Debug.Log("TileMapManager_Multiplayer.RotateTiles() : " + ex.Message);
                return false;
            }
        ...
        public bool ApplyMaterialToTiles()
        {
            try
            {
                for (int z = 0; z < SIZE_Z; z++)
                {
                    for (int x = 0; x < SIZE_X; x++)
                    {
                        eTileType tileType = m_mainScript.TileMap[x, z];
